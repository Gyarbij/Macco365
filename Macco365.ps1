<#
  .SYNOPSIS
  Performs a Microsoft 365 security assessment.

  .DESCRIPTION
  Automate the security assessment of Microsoft O/M 365 environments. By @Gyarbij

  .PARAMETER OrgName
  The name of the core organization or "company" of the O365 instance, which will be inspected.

  .PARAMETER OutPath
  The path to a folder where the report generated by Macco365 will be placed.
...
function Parse-Template {
	$template = (Get-Content ".\Macco365DefaultTemplate.html") -join "`n"
